 ...
 */
export const MantineProvider: React.FC<MantineProviderProps> = ({ children, theme = defaultTheme }: MantineProviderProps): JSX.Element => {
	return (
		<Mantine theme={createTheme(theme)}>
			{children}
		</Mantine>
	);
};