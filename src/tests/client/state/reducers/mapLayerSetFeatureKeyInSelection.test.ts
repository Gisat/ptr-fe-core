...
import { fullAppSharedStateMock } from '../mocks/fullAppSharedState.mock';
	...
	it('throws when payload is missing', () => {
		const state = { ...fullAppSharedStateMock };
		const invalidAction = { type: StateActionType.MAP_LAYER_SET_FEATURE_KEY } as unknown as ActionMapLayerSetFeatureKey;
		expect(() => reduceHandlerSetFeatureKeyInSelections(state, invalidAction)).toThrow(
